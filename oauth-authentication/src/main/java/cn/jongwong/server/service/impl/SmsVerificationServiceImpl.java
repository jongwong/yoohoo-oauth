...
public class SmsVerificationServiceImpl implements SmsVerificationService {
    ...
    // 模拟发送验证码
    @Override
    public Mono<AuthenticationSmsSendRO> sendVerificationCode(String mobileNumber) {
        ...
        return Mono.defer(() -> {
            ...
            try {
                ...
                AuthenticationSmsSendRO authenticationSmsSendRO = new AuthenticationSmsSendRO();
                authenticationSmsSendRO.setExpireIn(expiryTimeInSeconds);
                ...
                return smsCodeService
                        ...
                        .flatMap(success -> {
                            ...
                            if (Boolean.TRUE.equals(success)) {
                                ...
                                return Mono.just(authenticationSmsSendRO); // 成功发送
                            } else {
